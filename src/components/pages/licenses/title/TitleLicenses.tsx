            ...
            <div className="row my-5 d-flex justify-content-center text-center title-licenses">
                <div className="col-12 col-md-10 col-lg-8 my-5">
                    ...
                    <motion.p
                        ...
                        >
                            Descarga la <strong>licencia</strong> que necesites. Podrás ver su <strong>información relevante</strong> y los <strong>archivos descargables</strong>. Si tienes dudas sobre algo puedes ir a la sección de preguntas frecuentes.
                    </motion.p>
                </div>
            </div>
        </section>
